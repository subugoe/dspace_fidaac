...
<xsl:template match="crossref/journal/journal_metadata">
        <dim:field element="bibliographicCitation" qualifier="journal" mdschema="dc">
...
<xsl:template match="crossref/book/book_series_metadata/series_metadata/titles/title">
