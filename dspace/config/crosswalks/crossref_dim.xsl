...
<xsl:template match="doi_record">
		...
		<xsl:call-template name="book_series1" />
...
<!--<xsl:for-each select=".">
  <xsl:choose>
    <xsl:if test="position() = 1">-->
     ...
     <!--</xsl:if>-->
        <dim:field element="title" qualifier="alternative" mdschema="dc">
                <xsl:value-of select="crf:subtitle" />
        </dim:field>
        <xsl:call-template name="newline" />
<!--   </xsl:choose>
</xsl:for-each>-->
...
<!-- templates for book in series -->

<xsl:template match ="crossref/book/book_series_metadata/doi_data/doi">
        <dim:field element="identifier" qualifier="doi" mdschema="dc">
                <xsl:value-of select="." />
        </dim:field>
        <xsl:call-template name="newline" />
...
<xsl:template match ="crossref/book/book_series_metadata/titles/title">
...
<xsl:template match ="crossref/book/book_series_metadata/titles/subtitle">
...
<xsl:template name="book_series1">
    <xsl:if test="crossref/book/book_series_metadata/series_metadata/titles/title">
        <dim:field element ="relation" qualifier="ispartofseries" mdschema="dc">
			<xsl:value-of select="crossref/book/book_series_metadata/series_metadata/titles/title" />
			<xsl:text>; </xsl:text>
			<xsl:value-of select="crossref/book/book_series_metadata/volume" />
		</dim:field>
        <xsl:call-template name="newline" />
     </xsl:if>
</xsl:template>

<xsl:template match ="crossref/book/book_series_metadata/series_metadata/issn">
...
<xsl:template match="crossref/book/book_series_metadata/publication_date" >
 <xsl:choose>
...
<xsl:template match="crossref/book/book_series_metadata/contributors/person_name">
...
<xsl:template match="crossref/book/book_series_metadata/isbn[@media_type='electronic']" >
...
<xsl:template match="crossref/book/book_series_metadata/isbn[@media_type='print']" >
        <dim:field element="identifier" qualifier="isbn" mdschema="dc">
                <xsl:value-of select="." />
        </dim:field>
        <xsl:call-template name="newline" />
...
<xsl:template match="crossref/book/book_series_metadata/publisher/publisher_name" >
...
<xsl:template match="crossref/book/book_series_metadata/publisher/publisher_place" >
...
<xsl:template match="crossref/book/book_series_metadata">
    <xsl:if test="./@language">
        <dim:field element="language" qualifier="iso" mdschema="dc">
                <xsl:value-of select="@language" />
        </dim:field>
...
<xsl:template match ="crf:crossref/crf:book/crf:book_metadata/crf:titles/crf:title">
<!--<xsl:for-each select=".">-->
  <dim:field element="title" mdschema="dc">
<!--  <xsl:if test="position() &lt; 1">
...
<xsl:template match ="crf:crossref/crf:book/crf:book_metadata/crf:titles/crf:subtitle">
  <dim:field element="title" qualifier="alternative" mdschema="dc">
                <xsl:value-of select="." />
   </dim:field>
        <xsl:call-template name="newline" />
...
<xsl:template match ="crossref/book/book_metadata/titles/title">
...
<xsl:template match ="crossref/book/book_metadata/titles/subtitle">
