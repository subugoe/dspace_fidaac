...
<xsl:stylesheet
		...
		xmlns:ds3="http://datacite.org/schema/kernel-4"
...
<xsl:template match="/ds3:resource">
    <dim:dim>
        <xsl:apply-templates />
    </dim:dim>
</xsl:template>
...
<xsl:template match="ds3:language">
    <dim:field element="language" qualifier="iso" mdschema="dc">
        <xsl:value-of select="." />
    </dim:field>
</xsl:template>
...
<xsl:template match="ds3:titles/ds3:title">
        <dim:field element="title" mdschema="dc">
            <xsl:value-of select="." />
        </dim:field>
</xsl:template>
...
<xsl:template match="ds3:titles/ds3:title[@titleType='Subtitle']">
        <dim:field element="title" qualifier="alternative" mdschema="dc">
            <xsl:value-of select="." />
        </dim:field>
</xsl:template>
...
<xsl:template match="ds3:creators">
    <xsl:for-each select="ds3:creator/ds3:creatorName">
        <dim:field element="contributor" qualifier="author" mdschema="dc">
            <xsl:value-of select="." />
        </dim:field>
    </xsl:for-each>
...
<xsl:template match="ds3:publisher">
        <dim:field element="publisher" mdschema="dc">
            <xsl:value-of select="substring-before(., ',')" />
        </dim:field>
        <dim:field element="publishedIn" mdschema="dc">
...
<xsl:template match="ds3:identifier[@identifierType='DOI']">
        <dim:field element="identifier" qualifier="doi" mdschema="dc">
            <xsl:value-of select="." />
        </dim:field>
</xsl:template>
...
<xsl:template match="ds3:identifier[@identifierType='issn']">
        <dim:field element="identifier" qualifier="issn" mdschema="dc">
            <xsl:value-of select="." />
        </dim:field>
</xsl:template>
...
<xsl:template match="ds3:publicationYear">
    <dim:field element="date" qualifier="issued" mdschema="dc">
        <xsl:value-of select="." />
    </dim:field>
</xsl:template>
...
<xsl:template match="ds3:contributors">
    <xsl:for-each select="ds3:contributor[@contributorType='Editor']/ds3:contributorName">
        <dim:field element="contributor" qualifier="editor" mdschema="dc">
            <xsl:value-of select="." />
        </dim:field>
    </xsl:for-each>
...
<xsl:template match="ds3:relatedIdentifiers/ds3:relatedIdentifier[@relatedIdentifierType='ISSN'][@relationType='IsPartOf']">
        <dim:field element="relation" qualifier="issn" mdschema="dc">
            <xsl:value-of select="." />
        </dim:field>
</xsl:template>
...
<xsl:template match="ds3:descriptions">
    <xsl:for-each select="ds3:description[@descriptionType='Abstract']">
        <dim:field element="description" qualifier="abstract" mdschema="dc">
            <xsl:value-of select="." />
        </dim:field>
    </xsl:for-each>
<!--Funktioniert für ASJ-->
    <xsl:for-each select="ds3:description[@descriptionType='SeriesInformation']">
        <dim:field element="relation" qualifier="journal" mdschema="dc">
            <xsl:value-of select="substring-before(., ';')" />
        </dim:field>
        <dim:field element="relation" qualifier="volume" mdschema="dc">
